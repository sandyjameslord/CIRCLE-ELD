...
class WorksheetTwoApp(tk.Tk):
    ...
    def __init__(self, theme, unit_number, *args, **kwargs):
        ...
        container.master.title("Worksheet Two: 'Listening and Speaking'")
        ...
        pages_to_view = (WorksheetTwo, Instructions)
...
class WorksheetTwo(tk.Frame):
    def __init__(self, parent, controller):
        ...
        playback_button = tk.Button(self, text="Play again")
...
3.  AB sentences are a good warm up--
   --BC sentences are a challenge!"""
        ...
        proceed_to_worksheet_button = tk.Button(instructions_frame, bg='SlateGray1', text="To the Lesson",
                                                ...
                                                command=lambda: controller.show_frame("WorksheetTwo"))
